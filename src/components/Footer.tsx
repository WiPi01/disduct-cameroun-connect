        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              La première plateforme de commerce en ligne qui connecte l'offre
              et la demande de produits et services au Cameroun.
            </p>
            <div className="flex space-x-4">
              ...
              >
                <img
                  src="/lovable-uploads/1ec331ef-0978-439e-9fbd-dfe2b12f5570.png"
                  alt="TikTok"
                  className="h-5 w-5"
                />
              </a>

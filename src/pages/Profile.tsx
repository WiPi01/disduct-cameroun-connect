      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 sm:grid-cols-6 h-auto gap-1 p-1">
            <TabsTrigger value="overview" className="text-xs sm:text-sm px-2 py-1.5">Aperçu</TabsTrigger>
            <TabsTrigger value="favorites" className="text-xs sm:text-sm px-2 py-1.5">Favoris</TabsTrigger>
            <TabsTrigger value="sales" className="text-xs sm:text-sm px-2 py-1.5">Ventes</TabsTrigger>
            <TabsTrigger value="purchases" className="text-xs sm:text-sm px-2 py-1.5">Achats</TabsTrigger>
            <TabsTrigger value="conversations" className="text-xs sm:text-sm px-2 py-1.5">Messages</TabsTrigger>
            <TabsTrigger value="settings" className="text-xs sm:text-sm px-2 py-1.5">Config</TabsTrigger>
          </TabsList>
